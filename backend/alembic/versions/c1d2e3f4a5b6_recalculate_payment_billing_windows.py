"""recalculate payment billing windows using joining day

Revision ID: c1d2e3f4a5b6
Revises: a6e5b7c8d9f0
...
down_revision: Union[str, Sequence[str], None] = "a6e5b7c8d9f0"
...
def downgrade() -> None:
    # Data correction only; nothing to revert safely.
    pass
